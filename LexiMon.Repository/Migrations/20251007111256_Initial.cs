    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "5d7efb6d-0d52-4159-ab2e-7fd356973925", 0, null, null, "f624f6f5-82dc-4d13-b2bc-30e5766272f7", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "free@example.com", true, null, 3, null, false, null, "FREE@EXAMPLE.COM", "FREE@EXAMPLE.COM", "AQAAAAIAAYagAAAAECGx/vIDSTDpLzY9/Nypq6pVsr10TL8YDEsnb//olFLAMpG49L9Az11gBv5VzjihNw==", null, false, "ddf74669-f500-451c-acbb-58869d55843d", true, false, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "free@example.com" },
                    { "88f1581b-4f4e-4831-8cf8-ee4afed04c11", 0, null, null, "70570a68-7f31-440a-93a7-bea7edf1c762", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "admin@example.com", true, null, 3, null, false, null, "ADMIN@EXAMPLE.COM", "ADMIN@EXAMPLE.COM", "AQAAAAIAAYagAAAAEGH9B3l4GHHyqxPqJajdO2CsRLVet1dBVnajz2wxNas7RP7UAh0ZM0F0VBuTC85CYQ==", null, false, "20686dde-0949-4922-be56-cc93a2ab8104", true, false, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "admin@example.com" },
                    { "c2765f80-383f-46f2-9a73-ec47863100ae", 0, null, null, "5d26826b-bbd5-4240-bbef-9daf94062189", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "premium@example.com", true, null, 3, null, false, null, "PREMIUM@EXAMPLE.COM", "PREMIUM@EXAMPLE.COM", "AQAAAAIAAYagAAAAEGSHXOCexsUGFDLRljkQr28zOrv+HuEMQjF/+/BcEPm5d3zl8DMClesK7A3m49B0Fg==", null, false, "38b73c3d-e8bf-47b1-9bf4-3d065cd45daa", true, false, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "premium@example.com" }
                });
